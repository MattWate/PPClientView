...
import SiteReportPage from './pages/SiteReportPage.jsx'; // <-- ADD THIS IMPORT
...
      <Route path="/supervisor-view/:areaId" element={<SupervisorAreaView />} />
      ...
      {/* Route for the printable site report */}
      <Route path="/report/site" element={<SiteReportPage />} /> {/* <-- ADD THIS NEW ROUTE */}
